...
namespace Validator
{
    internal class Validator
    {
        ...
        public static int GetUserNumberInt(string message)
        {
            ...
            {
                Console.Write("\nInvalid entry. Please enter the associated number for the Genre you're interested in (1-5): ");
            }
            //input is now valid
            return result;
        }
        ...
        public static bool GetContinue()
        {
            ...
            while (true)
            {
                Console.Write("Would you like to look up another Genre? y/n: ");
                ...
                {
                    Console.Write("That was an invalid entry. Try again: ");
                }
            }
            return result;
        }
